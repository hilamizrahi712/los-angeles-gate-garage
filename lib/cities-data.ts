...
export const CITIES: CityData[] = [
  {
    slug: "woodland-hills",
    nearby: ["canoga-park", "tarzana", "calabasas", "reseda", "encino"],
    arrivalTime: "Arrival within 1 hour",
    name: "Woodland Hills",
    metaTitle: "Gate & Garage Door Repair Woodland Hills CA | Real Gate & Garage Door",
    metaDescription: "Expert gate and garage door repair in Woodland Hills, CA. Same-day service, upfront pricing, fully insured. Call (818) 915-5715.",
    heroH1: "Gate & Garage Door Repair in Woodland Hills, CA",
    heroSubtitle: "Woodland Hills' trusted local repair specialists — same-day service, upfront pricing, bonded and insured.",
...
We cover all of Woodland Hills including the neighborhoods near Calabasas border, Warner Center, the Mulholland corridor, and everything in between. Same-day service is available for most repair calls. Emergency service is available 24/7.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Woodland Hills?", a: "Woodland Hills sees San Fernando Valley summer highs of 95–105°F with far less coastal cooling than the Westside, and that heat is hard on gate motors and garage door openers — thermal expansion, motor overheating, and capacitor wear all show up more often here than in coastal neighborhoods." },
      { q: "What kind of gate and garage door setups are common in Woodland Hills?", a: "Woodland Hills has a mix of mid-century tract homes with original single-car garages and larger hillside or estate properties with long custom driveway gates, so we carry parts for both older single-panel openers and heavier-duty gate operators." },
    ],
  },
  {
    slug: "sherman-oaks",
    nearby: ["encino", "studio-city", "van-nuys", "tarzana", "beverly-hills"],
    arrivalTime: "Arrival within 1 hour",
    name: "Sherman Oaks",
    metaTitle: "Gate & Garage Door Repair Sherman Oaks CA | Real Gate & Garage Door",
    metaDescription: "Same-day gate and garage door repair in Sherman Oaks, CA. Insured technicians, upfront pricing. Call (818) 915-5715.",
...
We cover all of Sherman Oaks including the neighborhoods near Ventura Blvd, the hills above Mulholland, Van Nuys Blvd, and the Sepulveda area. Same-day service available Monday through Sunday.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Sherman Oaks?", a: "Summer temperatures in Sherman Oaks regularly climb past 100°F in the Valley's hot, dry microclimate, which accelerates wear on gate operator capacitors and garage door opener circuit boards compared to cooler parts of Los Angeles." },
      { q: "What kind of gate and garage door setups are common in Sherman Oaks?", a: "Homes in Sherman Oaks range from 1950s–70s tract houses with original garage hardware to newer hillside properties with custom automatic driveway gates, which means service calls here span both legacy repairs and modern operator systems." },
      { q: "What gate and garage door brands do you repair in Sherman Oaks?", a: "We repair and service all major brands for Sherman Oaks customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "encino",
    nearby: ["tarzana", "sherman-oaks", "van-nuys", "woodland-hills", "bel-air"],
    arrivalTime: "Arrival within 1 hour",
    name: "Encino",
...
We serve all of Encino including Encino Hills, the Encino Reservoir area, and neighborhoods along Ventura and Balboa Boulevards.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Encino?", a: "Encino sits in the San Fernando Valley's hot-summer belt, where 95–105°F days are common from July through September and put extra strain on gate operator motors and garage door opener electronics." },
      { q: "What kind of gate and garage door setups are common in Encino?", a: "Encino properties typically fall into two categories — older tract-home garages original to the house, and larger estate-style lots with automatic driveway gates — and we stock parts for both." },
      { q: "Do you offer emergency weekend or after-hours service in Encino?", a: "Yes. Our emergency line is answered 24/7 for Encino customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "calabasas",
    nearby: ["woodland-hills", "canoga-park", "malibu", "thousand-oaks", "tarzana"],
    arrivalTime: "Arrival within 1 hour",
    name: "Calabasas",
    metaTitle: "Gate & Garage Door Repair Calabasas CA | Real Gate & Garage Door",
    metaDescription: "Same-day gate and garage door repair in Calabasas, CA. Gated community specialists, bonded, insured. Call (818) 915-5715.",
    ...
    extraKeywords: ["garage door repair Calabasas CA", "driveway gate installation Calabasas", "gate repair Calabasas", "electric gate repair Calabasas", "driveway gate repair Calabasas", "garage door spring repair Calabasas", "gate opener repair Calabasas"],
...
We cover all of Calabasas including The Oaks at Calabasas, Hidden Hills adjacent properties, Mulholland Estates, The Calabasas Highlands, and all other neighborhoods.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Calabasas?", a: "Calabasas sees San Fernando Valley summer highs of 95–105°F with far less coastal cooling than the Westside, and that heat is hard on gate motors and garage door openers — thermal expansion, motor overheating, and capacitor wear all show up more often here than in coastal neighborhoods." },
      { q: "What kind of gate and garage door setups are common in Calabasas?", a: "Calabasas has a mix of mid-century tract homes with original single-car garages and larger hillside or estate properties with long custom driveway gates, so we carry parts for both older single-panel openers and heavier-duty gate operators." },
      { q: "How much notice do you need for a same-day appointment in Calabasas?", a: "Most Calabasas customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  {
    slug: "tarzana",
    nearby: ["encino", "reseda", "woodland-hills", "sherman-oaks", "van-nuys"],
    arrivalTime: "Arrival within 1 hour",
    name: "Tarzana",
    metaTitle: "Gate & Garage Door Repair Tarzana CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Tarzana, CA. Same-day service, insured technicians, upfront pricing. Call (818) 915-5715.",
...
We cover all of Tarzana including the areas near Reseda Boulevard, Ventura Boulevard, and the hillside streets above Calvert Street. Same-day service is available throughout Tarzana seven days a week.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Tarzana?", a: "Summer temperatures in Tarzana regularly climb past 100°F in the Valley's hot, dry microclimate, which accelerates wear on gate operator capacitors and garage door opener circuit boards compared to cooler parts of Los Angeles." },
      { q: "What kind of gate and garage door setups are common in Tarzana?", a: "Homes in Tarzana range from 1950s–70s tract houses with original garage hardware to newer hillside properties with custom automatic driveway gates, which means service calls here span both legacy repairs and modern operator systems." },
      { q: "Do you service commercial properties and businesses in Tarzana?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Tarzana businesses in addition to residential properties." },
    ],
  },
  {
    slug: "chatsworth",
    nearby: ["northridge", "canoga-park", "reseda", "woodland-hills", "simi-valley"],
    arrivalTime: "Arrival within 1 hour",
    name: "Chatsworth",
    ...
    heroSubtitle: "Chatsworth's local gate and garage door repair experts — fast response, fair prices, fully insured.",
...
We cover all of Chatsworth including the area near the 118 Freeway, Box Canyon, Stoney Point, and the equestrian neighborhoods near Devonshire Street. Same-day service available throughout Chatsworth.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Chatsworth?", a: "Chatsworth sits in the San Fernando Valley's hot-summer belt, where 95–105°F days are common from July through September and put extra strain on gate operator motors and garage door opener electronics." },
      { q: "What kind of gate and garage door setups are common in Chatsworth?", a: "Chatsworth properties typically fall into two categories — older tract-home garages original to the house, and larger estate-style lots with automatic driveway gates — and we stock parts for both." },
      { q: "Do you service gated communities and HOA properties in Chatsworth?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Chatsworth gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "van-nuys",
    nearby: ["sherman-oaks", "reseda", "north-hollywood", "northridge", "encino"],
    arrivalTime: "Arrival within 1 hour",
    name: "Van Nuys",
...
We cover all of Van Nuys including neighborhoods near Van Nuys Boulevard, the 405 corridor, Sherman Way, and Vanowen Street. Same-day service seven days a week.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Van Nuys?", a: "Van Nuys sees San Fernando Valley summer highs of 95–105°F with far less coastal cooling than the Westside, and that heat is hard on gate motors and garage door openers — thermal expansion, motor overheating, and capacitor wear all show up more often here than in coastal neighborhoods." },
      { q: "What kind of gate and garage door setups are common in Van Nuys?", a: "Van Nuys has a mix of mid-century tract homes with original single-car garages and larger hillside or estate properties with long custom driveway gates, so we carry parts for both older single-panel openers and heavier-duty gate operators." },
      { q: "What gate and garage door brands do you repair in Van Nuys?", a: "We repair and service all major brands for Van Nuys customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "reseda",
    nearby: ["northridge", "tarzana", "canoga-park", "van-nuys", "woodland-hills"],
    arrivalTime: "Arrival within 1 hour",
    name: "Reseda",
    metaTitle: "Gate & Garage Door Repair Reseda CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Reseda, CA. Same-day service, all brands, bonded & insured. Call (818) 915-5715.",
    ...
    extraKeywords: ["garage door repair Reseda CA", "gate installation Reseda", "electric gate repair Reseda", "driveway gate repair Reseda", "garage door spring repair Reseda", "gate opener repair Reseda"],
...
We cover all of Reseda including the areas near Victory Boulevard, Vanowen, Reseda Boulevard, and the residential streets throughout the community. Available seven days a week.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Reseda?", a: "Summer temperatures in Reseda regularly climb past 100°F in the Valley's hot, dry microclimate, which accelerates wear on gate operator capacitors and garage door opener circuit boards compared to cooler parts of Los Angeles." },
      { q: "What kind of gate and garage door setups are common in Reseda?", a: "Homes in Reseda range from 1950s–70s tract houses with original garage hardware to newer hillside properties with custom automatic driveway gates, which means service calls here span both legacy repairs and modern operator systems." },
      { q: "Do you offer emergency weekend or after-hours service in Reseda?", a: "Yes. Our emergency line is answered 24/7 for Reseda customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "northridge",
    nearby: ["reseda", "chatsworth", "canoga-park", "van-nuys", "woodland-hills"],
    arrivalTime: "Arrival within 1 hour",
    name: "Northridge",
    metaTitle: "Gate & Garage Door Repair Northridge CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Northridge, CA. Same-day service, all brands, fully insured. Call (818) 915-5715.",
    ...
    extraKeywords: ["garage door repair Northridge CA", "gate installation Northridge", "electric gate repair Northridge", "driveway gate repair Northridge", "garage door spring repair Northridge", "gate opener repair Northridge"],
...
We cover all of Northridge including the CSUN area, neighborhoods near the 118 and 405 interchange, and residential streets throughout the community. Same-day service seven days a week.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Northridge?", a: "Northridge sits in the San Fernando Valley's hot-summer belt, where 95–105°F days are common from July through September and put extra strain on gate operator motors and garage door opener electronics." },
      { q: "What kind of gate and garage door setups are common in Northridge?", a: "Northridge properties typically fall into two categories — older tract-home garages original to the house, and larger estate-style lots with automatic driveway gates — and we stock parts for both." },
      { q: "How much notice do you need for a same-day appointment in Northridge?", a: "Most Northridge customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  {
    slug: "north-hollywood",
    nearby: ["studio-city", "burbank", "van-nuys", "sherman-oaks", "glendale"],
    arrivalTime: "Arrival within 1 hour",
    name: "North Hollywood",
    metaTitle: "Gate & Garage Door Repair North Hollywood CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in North Hollywood, CA. Same-day service, all brands. Bonded & insured. Call (818) 915-5715.",
...
We cover all of North Hollywood including the NoHo Arts District, neighborhoods near the 170 Freeway, Lankershim Blvd, and Valley Village. Same-day service available seven days a week.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in North Hollywood?", a: "North Hollywood sees San Fernando Valley summer highs of 95–105°F with far less coastal cooling than the Westside, and that heat is hard on gate motors and garage door openers — thermal expansion, motor overheating, and capacitor wear all show up more often here than in coastal neighborhoods." },
      { q: "What kind of gate and garage door setups are common in North Hollywood?", a: "North Hollywood has a mix of mid-century tract homes with original single-car garages and larger hillside or estate properties with long custom driveway gates, so we carry parts for both older single-panel openers and heavier-duty gate operators." },
      { q: "Do you service commercial properties and businesses in North Hollywood?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for North Hollywood businesses in addition to residential properties." },
    ],
  },
  {
    slug: "studio-city",
    nearby: ["sherman-oaks", "north-hollywood", "burbank", "van-nuys", "hollywood"],
    arrivalTime: "Arrival within 1 hour",
    name: "Studio City",
    metaTitle: "Gate & Garage Door Repair Studio City CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Studio City, CA. Same-day service, bonded, insured. Call (818) 915-5715.",
...
We cover all of Studio City including the hills above Mulholland, Fryman Road, Coldwater Canyon, Ventura Boulevard, and the flats near Woodbridge.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Studio City?", a: "Summer temperatures in Studio City regularly climb past 100°F in the Valley's hot, dry microclimate, which accelerates wear on gate operator capacitors and garage door opener circuit boards compared to cooler parts of Los Angeles." },
      { q: "What kind of gate and garage door setups are common in Studio City?", a: "Homes in Studio City range from 1950s–70s tract houses with original garage hardware to newer hillside properties with custom automatic driveway gates, which means service calls here span both legacy repairs and modern operator systems." },
      { q: "Do you service gated communities and HOA properties in Studio City?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Studio City gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "burbank",
    nearby: ["glendale", "north-hollywood", "studio-city", "pasadena", "los-feliz"],
    arrivalTime: "Arrival within 1 hour",
    name: "Burbank",
    metaTitle: "Gate & Garage Door Repair Burbank CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Burbank, CA. Same-day service, emergency available, fully insured. Call (818) 915-5715.",
...
We cover all of Burbank including Downtown Burbank, Magnolia Park, the Rancho area, Chandler Boulevard, and the Media District. Same-day service seven days a week, with 24/7 emergency response.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Burbank?", a: "Burbank sits in the San Fernando Valley's hot-summer belt, where 95–105°F days are common from July through September and put extra strain on gate operator motors and garage door opener electronics." },
      { q: "What kind of gate and garage door setups are common in Burbank?", a: "Burbank properties typically fall into two categories — older tract-home garages original to the house, and larger estate-style lots with automatic driveway gates — and we stock parts for both." },
      { q: "What gate and garage door brands do you repair in Burbank?", a: "We repair and service all major brands for Burbank customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "glendale",
    nearby: ["burbank", "pasadena", "eagle-rock", "los-feliz", "silver-lake"],
    arrivalTime: "Arrival within 1 hour",
    name: "Glendale",
    metaTitle: "Gate & Garage Door Repair Glendale CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Glendale, CA. Same-day service, all brands, bonded & insured. Call (818) 915-5715.",
    heroH1: "Gate & Garage Door Repair in Glendale, CA",
    heroSubtitle: "Glendale's trusted gate and garage door repair service — fast response, honest pricing, fully insured.",
    extraKeywords: ["garage door repair Glendale CA", "garage door installation Glendale CA", "gate repair Glendale", "electric gate repair Glendale", "driveway gate repair Glendale", "garage door spring repair Glendale", "gate opener repair Glendale"],
...
Whether you're in Montrose, Adams Hill, Sparr Heights, Verdugo Woodlands, or central Glendale, we're available for same-day gate and garage door repair. Contact us for a free estimate or emergency service.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Glendale?", a: "Glendale sees San Fernando Valley summer highs of 95–105°F with far less coastal cooling than the Westside, and that heat is hard on gate motors and garage door openers — thermal expansion, motor overheating, and capacitor wear all show up more often here than in coastal neighborhoods." },
      { q: "What kind of gate and garage door setups are common in Glendale?", a: "Glendale has a mix of mid-century tract homes with original single-car garages and larger hillside or estate properties with long custom driveway gates, so we carry parts for both older single-panel openers and heavier-duty gate operators." },
      { q: "Do you offer emergency weekend or after-hours service in Glendale?", a: "Yes. Our emergency line is answered 24/7 for Glendale customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "canoga-park",
    nearby: ["woodland-hills", "chatsworth", "reseda", "northridge", "calabasas"],
    arrivalTime: "Arrival within 1 hour",
    name: "Canoga Park",
    metaTitle: "Gate & Garage Door Repair Canoga Park CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Canoga Park, CA. Same-day service, insured, fair pricing. Call (818) 915-5715.",
    ...
    extraKeywords: ["garage door repair Canoga Park CA", "gate repair Canoga Park", "electric gate repair Canoga Park", "driveway gate repair Canoga Park", "garage door spring repair Canoga Park", "gate opener repair Canoga Park"],
...
We cover all of Canoga Park including the neighborhoods near the 101 Freeway, Sherman Way, and Topanga Canyon Boulevard, as well as the residential streets throughout the community. Same-day service available seven days a week.`,
    ...
    faq: [
      ...
      { q: "What's the biggest climate factor affecting gates and garage doors in Canoga Park?", a: "Summer temperatures in Canoga Park regularly climb past 100°F in the Valley's hot, dry microclimate, which accelerates wear on gate operator capacitors and garage door opener circuit boards compared to cooler parts of Los Angeles." },
      { q: "What kind of gate and garage door setups are common in Canoga Park?", a: "Homes in Canoga Park range from 1950s–70s tract houses with original garage hardware to newer hillside properties with custom automatic driveway gates, which means service calls here span both legacy repairs and modern operator systems." },
      { q: "How much notice do you need for a same-day appointment in Canoga Park?", a: "Most Canoga Park customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  ...
  {
    slug: "los-angeles",
    nearby: ["hollywood", "west-hollywood", "silver-lake", "culver-city", "beverly-hills", "glendale"],
    arrivalTime: "Arrival within 1 hour",
    name: "Los Angeles",
    metaTitle: "Gate & Garage Door Repair Los Angeles CA | Real Gate & Garage Door",
    metaDescription: "Expert gate and garage door repair in Los Angeles, CA. Same-day service, 24/7 emergency, fully insured. Call (818) 915-5715.",
    heroH1: "Gate & Garage Door Repair in Los Angeles, CA",
    heroSubtitle: "Serving greater Los Angeles with same-day gate and garage door repair — honest pricing, insured technicians.",
...
We bring same-day service to residential and commercial customers throughout Los Angeles. Call us any time for a free estimate — we answer live 24/7.`,
    ...
    faq: [
      ...
      { q: "Are hillside or narrow driveways a factor in Los Angeles?", a: "Yes. Los Angeles includes hillside terrain with steep, narrow driveways, and those grades put extra strain on gate operators and can cause vibration-related wear on garage doors that flatter neighborhoods don't see as often." },
      { q: "Do older Los Angeles homes need special permit considerations for gate or garage door work?", a: "Some do. Los Angeles includes neighborhoods with historic-preservation overlay zones where visible exterior changes to gates or garage doors may need additional review — we can tell you during your estimate whether your property falls into one." },
      { q: "Do you service gated communities and HOA properties in Los Angeles?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Los Angeles gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "beverly-hills",
    nearby: ["west-hollywood", "bel-air", "culver-city", "santa-monica", "hollywood"],
    arrivalTime: "Arrival within 1 hour",
    name: "Beverly Hills",
    ...
    extraKeywords: ["gate repair Beverly Hills CA", "automatic gate Beverly Hills", "driveway gate Beverly Hills", "garage door repair Beverly Hills", "electric gate repair Beverly Hills", "driveway gate repair Beverly Hills", "garage door spring repair Beverly Hills", "gate opener repair Beverly Hills"],
...
Our technicians arrive in marked vehicles, dress professionally, and work cleanly. Beverly Hills customers receive the same upfront pricing and written warranty as every customer we serve. Same-day service is standard.`,
    ...
    faq: [
      ...
      { q: "Does the coastal air in Beverly Hills affect gate and garage door hardware?", a: "Yes. The coastal humidity and salt air around Beverly Hills speed up rust and corrosion on unprotected gate hinges, rollers, and steel components, so galvanized or powder-coated hardware holds up noticeably better than bare steel." },
      { q: "What types of properties do you service in Beverly Hills?", a: "Properties in Beverly Hills range from gated estates with elaborate driveway gate systems to narrower urban lots with standard single or double garages, and we service the full range." },
      { q: "Do you service gated communities and HOA properties in Beverly Hills?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Beverly Hills gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "west-hollywood",
    nearby: ["beverly-hills", "hollywood", "los-angeles", "bel-air", "silver-lake"],
    arrivalTime: "Arrival within 1 hour",
    name: "West Hollywood",
    ...
    extraKeywords: ["gate repair West Hollywood CA", "electric gate West Hollywood", "garage door repair WeHo", "electric gate repair West Hollywood", "driveway gate repair West Hollywood", "garage door spring repair West Hollywood", "gate opener repair West Hollywood"],
...
Same-day service is available throughout West Hollywood seven days a week. For emergencies, we're available 24/7.`,
    ...
    faq: [
      ...
      { q: "Does the coastal air in West Hollywood affect gate and garage door hardware?", a: "Yes. West Hollywood's marine layer and salt air are harder on metal gate components than inland neighborhoods, which is why we check hinges, springs, and exposed hardware for early corrosion on every coastal service call." },
      { q: "What types of properties do you service in West Hollywood?", a: "West Hollywood has a wide property mix — from large gated estates to tightly spaced urban homes — so the gate and garage door systems we service here vary more in scale than in most neighborhoods." },
      { q: "What gate and garage door brands do you repair in West Hollywood?", a: "We repair and service all major brands for West Hollywood customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "santa-monica",
    nearby: ["culver-city", "malibu", "beverly-hills", "bel-air", "los-angeles"],
    arrivalTime: "Arrival within 1 hour",
    name: "Santa Monica",
    ...
    heroSubtitle: "Serving Santa Monica with same-day gate repair and garage door service — honest pricing, insured technicians.",
    extraKeywords: ["gate repair Santa Monica CA", "driveway gate Santa Monica", "garage door repair Santa Monica", "electric gate repair Santa Monica", "driveway gate repair Santa Monica", "garage door spring repair Santa Monica", "gate opener repair Santa Monica"],
...
Call us for same-day service anywhere in Santa Monica. We service both residential and commercial properties and are available 24/7 for emergencies.`,
    ...
    faq: [
      ...
      { q: "Does the coastal air in Santa Monica affect gate and garage door hardware?", a: "Yes. Santa Monica's marine layer keeps temperatures mild but carries persistent salt-laden air, which accelerates corrosion on exposed hinges, tracks, and steel gate hardware faster than it would inland — we recommend corrosion-resistant hardware and more frequent lubrication here." },
      { q: "What types of properties do you service in Santa Monica?", a: "Santa Monica spans everything from large estate properties with custom automatic driveway gates to dense, high-value urban lots with tight-clearance garages, so our technicians work on both heavy-duty commercial-grade operators and compact residential openers." },
      { q: "Do you offer emergency weekend or after-hours service in Santa Monica?", a: "Yes. Our emergency line is answered 24/7 for Santa Monica customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "malibu",
    nearby: ["santa-monica", "calabasas", "woodland-hills", "thousand-oaks"],
    arrivalTime: "Arrival within 1 hour",
    name: "Malibu",
    ...
    extraKeywords: ["gate repair Malibu CA", "estate gate repair Malibu", "automatic gate Malibu", "electric gate repair Malibu", "driveway gate repair Malibu", "garage door spring repair Malibu", "gate opener repair Malibu"],
...
Our Malibu customers expect fast response and professional service, and that's what we deliver. Same-day appointments are available. Emergency service is available 24/7.`,
    ...
    faq: [
      ...
      { q: "Does the coastal air in Malibu affect gate and garage door hardware?", a: "Yes. The coastal humidity and salt air around Malibu speed up rust and corrosion on unprotected gate hinges, rollers, and steel components, so galvanized or powder-coated hardware holds up noticeably better than bare steel." },
      { q: "What types of properties do you service in Malibu?", a: "Properties in Malibu range from gated estates with elaborate driveway gate systems to narrower urban lots with standard single or double garages, and we service the full range." },
      { q: "How much notice do you need for a same-day appointment in Malibu?", a: "Most Malibu customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  {
    slug: "culver-city",
    nearby: ["santa-monica", "beverly-hills", "los-angeles", "west-hollywood", "manhattan-beach"],
    arrivalTime: "Arrival within 1 hour",
    name: "Culver City",
    metaTitle: "Gate & Garage Door Repair Culver City CA | Real Gate & Garage Door",
    metaDescription: "Same-day gate and garage door repair in Culver City, CA. All brands, insured technicians. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Culver City CA", "garage door repair Culver City", "electric gate repair Culver City", "driveway gate repair Culver City", "garage door spring repair Culver City", "gate opener repair Culver City"],
...
Same-day service is standard for Culver City repair calls. Call or fill out our form for a free estimate.`,
    ...
    faq: [
      ...
      { q: "Does the coastal air in Culver City affect gate and garage door hardware?", a: "Yes. Culver City's marine layer and salt air are harder on metal gate components than inland neighborhoods, which is why we check hinges, springs, and exposed hardware for early corrosion on every coastal service call." },
      { q: "What types of properties do you service in Culver City?", a: "Culver City has a wide property mix — from large gated estates to tightly spaced urban homes — so the gate and garage door systems we service here vary more in scale than in most neighborhoods." },
      { q: "Do you service commercial properties and businesses in Culver City?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Culver City businesses in addition to residential properties." },
    ],
  },
  {
    slug: "pasadena",
    nearby: ["glendale", "eagle-rock", "alhambra", "burbank", "glendora"],
    arrivalTime: "Arrival within 1 hour",
    name: "Pasadena",
    ...
    extraKeywords: ["gate repair Pasadena CA", "automatic gate repair Pasadena", "garage door repair Pasadena CA", "electric gate repair Pasadena", "driveway gate repair Pasadena", "garage door spring repair Pasadena", "gate opener repair Pasadena"],
...
We cover all of Pasadena including San Pasqual, Bungalow Heaven, the Playhouse District, and every neighborhood in between. Same-day service is available most days.`,
    ...
    faq: [
      ...
      { q: "Does Santa Ana wind exposure affect service calls in Pasadena?", a: "Yes. Pasadena's inland San Gabriel Valley location means more Santa Ana wind exposure in fall than coastal LA, and wind-driven debris is one of the most common causes of gate sensor misalignment we diagnose here." },
      { q: "Are hillside driveways common in Pasadena?", a: "In the foothill areas of Pasadena, yes — sloped driveways are common, and the added grade puts more continuous load on gate operators than flat-lot properties see." },
      { q: "Do you service gated communities and HOA properties in Pasadena?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Pasadena gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "thousand-oaks",
    nearby: ["simi-valley", "camarillo", "calabasas", "malibu", "ventura-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Thousand Oaks",
    metaTitle: "Gate & Garage Door Repair Thousand Oaks CA | Real Gate & Garage Door",
    metaDescription: "Same-day gate and garage door repair in Thousand Oaks, CA. Bonded, insured, free estimates. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Thousand Oaks CA", "automatic gate Thousand Oaks", "garage door repair Thousand Oaks", "electric gate repair Thousand Oaks", "driveway gate repair Thousand Oaks", "garage door spring repair Thousand Oaks", "gate opener repair Thousand Oaks"],
...
Same-day service is available in Thousand Oaks. We're also available 24/7 for emergencies.`,
    ...
    faq: [
      ...
      { q: "Do agricultural surroundings affect gate systems in Thousand Oaks?", a: "Yes. Thousand Oaks's surrounding farmland means more dust and plant debris than urban areas, and that debris is a common cause of fouled gate tracks and misaligned photocell sensors on our service calls here." },
      { q: "Is hillside or wildfire-zone terrain a factor for gates in Thousand Oaks?", a: "In the hillside areas of Thousand Oaks, yes — those neighborhoods sit in higher wildfire-risk zones, which can affect defensible-space and clearance rules near gates and fencing that we factor into installation work." },
      { q: "Do you service gated communities and HOA properties in Thousand Oaks?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Thousand Oaks gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "simi-valley",
    nearby: ["thousand-oaks", "chatsworth", "camarillo", "canoga-park", "ventura-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Simi Valley",
    ...
    heroSubtitle: "Same-day gate and garage door repair for Simi Valley homes and businesses — insured, honest, reliable.",
    extraKeywords: ["gate repair Simi Valley CA", "garage door repair Simi Valley", "automatic gate Simi Valley", "electric gate repair Simi Valley", "driveway gate repair Simi Valley", "garage door spring repair Simi Valley", "gate opener repair Simi Valley"],
...
Coverage extends throughout Simi Valley including Wood Ranch, Berylwood, Kadota Fig, and all neighborhoods. Same-day and emergency service available.`,
    ...
    faq: [
      ...
      { q: "Do agricultural surroundings affect gate systems in Simi Valley?", a: "Yes. The agricultural land around Simi Valley generates more airborne dust and debris than urban neighborhoods, which regularly ends up in gate tracks and sensor housings." },
      { q: "Is hillside or wildfire-zone terrain a factor for gates in Simi Valley?", a: "Simi Valley's hillside terrain puts some neighborhoods in higher wildfire-risk zones, and that can affect clearance and material requirements for gates near vegetation — something we check on new installations." },
      { q: "What gate and garage door brands do you repair in Simi Valley?", a: "We repair and service all major brands for Simi Valley customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "silver-lake",
    nearby: ["los-feliz", "hollywood", "eagle-rock", "los-angeles", "glendale"],
    arrivalTime: "Arrival within 1 hour",
    name: "Silver Lake",
    ...
    extraKeywords: ["gate repair Silver Lake CA", "electric gate Silver Lake", "garage door repair Silver Lake", "electric gate repair Silver Lake", "driveway gate repair Silver Lake", "garage door spring repair Silver Lake", "gate opener repair Silver Lake"],
...
We cover all of Silver Lake including the reservoir area, Rowena, and the hillside communities off Glendale Boulevard.`,
    ...
    faq: [
      ...
      { q: "Are hillside or narrow driveways a factor in Silver Lake?", a: "Yes. Silver Lake includes hillside terrain with steep, narrow driveways, and those grades put extra strain on gate operators and can cause vibration-related wear on garage doors that flatter neighborhoods don't see as often." },
      { q: "Do older Silver Lake homes need special permit considerations for gate or garage door work?", a: "Some do. Silver Lake includes neighborhoods with historic-preservation overlay zones where visible exterior changes to gates or garage doors may need additional review — we can tell you during your estimate whether your property falls into one." },
      { q: "How much notice do you need for a same-day appointment in Silver Lake?", a: "Most Silver Lake customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  {
    slug: "los-feliz",
    nearby: ["silver-lake", "hollywood", "glendale", "eagle-rock", "burbank"],
    arrivalTime: "Arrival within 1 hour",
    name: "Los Feliz",
    ...
    extraKeywords: ["gate repair Los Feliz CA", "electric gate Los Feliz", "garage door repair Los Feliz", "electric gate repair Los Feliz", "driveway gate repair Los Feliz", "garage door spring repair Los Feliz", "gate opener repair Los Feliz"],
...
Same-day service available throughout Los Feliz. Emergency service available 24/7.`,
    ...
    faq: [
      ...
      { q: "Are hillside or narrow driveways a factor in Los Feliz?", a: "Yes. Los Feliz's hillside streets mean some driveways have real grade to them, and that incline adds load to gate motors and track alignment over time." },
      { q: "Do older Los Feliz homes need special permit considerations for gate or garage door work?", a: "In parts of Los Feliz with historic-preservation status, replacing a visible gate or garage door may require additional sign-off — something we check for before starting any exterior replacement work." },
      { q: "Do you offer emergency weekend or after-hours service in Los Feliz?", a: "Yes. Our emergency line is answered 24/7 for Los Feliz customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "eagle-rock",
    nearby: ["glendale", "pasadena", "los-feliz", "silver-lake", "alhambra"],
    arrivalTime: "Arrival within 1 hour",
    name: "Eagle Rock",
    metaTitle: "Gate & Garage Door Repair Eagle Rock CA | Real Gate & Garage Door",
    metaDescription: "Same-day gate and garage door repair in Eagle Rock, CA. All brands, insured technicians. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Eagle Rock CA", "garage door repair Eagle Rock", "electric gate repair Eagle Rock", "driveway gate repair Eagle Rock", "garage door spring repair Eagle Rock", "gate opener repair Eagle Rock"],
...
Call us for same-day service in Eagle Rock, seven days a week.`,
    ...
    faq: [
      ...
      { q: "Are hillside or narrow driveways a factor in Eagle Rock?", a: "Yes. Parts of Eagle Rock sit on hillside lots with steep or narrow driveway approaches, which is a common reason gate operators here wear out their drive components faster than on flat ground." },
      { q: "Do older Eagle Rock homes need special permit considerations for gate or garage door work?", a: "Some Eagle Rock properties sit in historic-preservation overlay zones, which can add a review step for visible gate or garage door changes — we flag this during the estimate so there are no surprises." },
      { q: "Do you service commercial properties and businesses in Eagle Rock?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Eagle Rock businesses in addition to residential properties." },
    ],
  },
  {
    slug: "hollywood",
    nearby: ["west-hollywood", "los-feliz", "silver-lake", "studio-city", "beverly-hills"],
    arrivalTime: "Arrival within 1 hour",
    name: "Hollywood",
    ...
    extraKeywords: ["garage door repair Hollywood CA", "gate repair Hollywood", "electric gate Hollywood Hills", "electric gate repair Hollywood", "driveway gate repair Hollywood", "garage door spring repair Hollywood", "gate opener repair Hollywood"],
...
We're available seven days a week for Hollywood repair calls, with 24/7 emergency service always available.`,
    ...
    faq: [
      ...
      { q: "Are hillside or narrow driveways a factor in Hollywood?", a: "Yes. Parts of Hollywood sit on hillside lots with steep or narrow driveway approaches, which is a common reason gate operators here wear out their drive components faster than on flat ground." },
      { q: "Do older Hollywood homes need special permit considerations for gate or garage door work?", a: "Some Hollywood properties sit in historic-preservation overlay zones, which can add a review step for visible gate or garage door changes — we flag this during the estimate so there are no surprises." },
      { q: "What gate and garage door brands do you repair in Hollywood?", a: "We repair and service all major brands for Hollywood customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "bel-air",
    nearby: ["beverly-hills", "encino", "sherman-oaks", "west-hollywood", "santa-monica"],
    arrivalTime: "Arrival within 1 hour",
    name: "Bel Air",
    ...
    extraKeywords: ["gate repair Bel Air CA", "estate gate repair Bel Air", "automatic gate Bel Air", "electric gate repair Bel Air", "driveway gate repair Bel Air", "garage door spring repair Bel Air", "gate opener repair Bel Air"],
...
All work in Bel Air is done with full professionalism. Our technicians arrive on time, work cleanly, and complete every job to the highest standard. Same-day service available.`,
    ...
    faq: [
      ...
      { q: "Does the coastal air in Bel Air affect gate and garage door hardware?", a: "Yes. Bel Air's marine layer keeps temperatures mild but carries persistent salt-laden air, which accelerates corrosion on exposed hinges, tracks, and steel gate hardware faster than it would inland — we recommend corrosion-resistant hardware and more frequent lubrication here." },
      { q: "What types of properties do you service in Bel Air?", a: "Bel Air spans everything from large estate properties with custom automatic driveway gates to dense, high-value urban lots with tight-clearance garages, so our technicians work on both heavy-duty commercial-grade operators and compact residential openers." },
      { q: "Do you service commercial properties and businesses in Bel Air?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Bel Air businesses in addition to residential properties." },
    ],
  },
  {
    slug: "alhambra",
    nearby: ["pasadena", "eagle-rock", "los-angeles", "hacienda-heights", "glendora"],
    arrivalTime: "Arrival within 1 hour",
    name: "Alhambra",
    metaTitle: "Gate & Garage Door Repair Alhambra CA | Real Gate & Garage Door",
    metaDescription: "Same-day gate and garage door repair in Alhambra, CA. All brands, insured technicians. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Alhambra CA", "garage door repair Alhambra", "electric gate repair Alhambra", "driveway gate repair Alhambra", "garage door spring repair Alhambra", "gate opener repair Alhambra"],
...
Same-day service is available in Alhambra. Call us for a free estimate.`,
    ...
    faq: [
      ...
      { q: "Does Santa Ana wind exposure affect service calls in Alhambra?", a: "Yes. Being further inland, Alhambra gets stronger Santa Ana wind events than coastal neighborhoods, and those winds regularly knock gate safety sensors out of alignment or blow debris into tracks." },
      { q: "Are hillside driveways common in Alhambra?", a: "Alhambra's foothill neighborhoods have a fair number of sloped driveways, which is one reason gate operator motors here tend to need drive-component service somewhat sooner than on flat terrain." },
      { q: "What gate and garage door brands do you repair in Alhambra?", a: "We repair and service all major brands for Alhambra customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  ...
  {
    slug: "santa-barbara",
    nearby: ["ventura", "oxnard", "camarillo", "ventura-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Santa Barbara",
    ...
    extraKeywords: ["gate repair Santa Barbara CA", "automatic gate Santa Barbara", "garage door repair Santa Barbara", "Montecito gate repair", "electric gate repair Santa Barbara", "driveway gate repair Santa Barbara", "garage door spring repair Santa Barbara", "gate opener repair Santa Barbara"],
    intro: `Santa Barbara's coastal estates, hillside haciendas, and Mission-style homes are home to some of the most elegant gate systems in Southern California. From the grand iron entry gates in Montecito to the private driveways winding up the Santa Ynez foothills, gate repair is a high-priority service throughout the Santa Barbara area. Real Gate & Garage Door brings insured, expert service directly to Santa Barbara homeowners.
...
We service all major gate operators and garage door systems installed throughout the Santa Barbara area: LiftMaster, Viking, DoorKing, Genie, and more. Same-day service is available for most repair calls. Emergency service is available 24/7.`,
    ...
    faq: [
      { q: "Do you service Montecito gate systems from Santa Barbara?", a: "Yes. We serve all of Santa Barbara and Montecito with the same same-day service and insured technicians." },
      ...
      { q: "Do agricultural surroundings affect gate systems in Santa Barbara?", a: "Yes. Santa Barbara's surrounding farmland means more dust and plant debris than urban areas, and that debris is a common cause of fouled gate tracks and misaligned photocell sensors on our service calls here." },
      { q: "Is hillside or wildfire-zone terrain a factor for gates in Santa Barbara?", a: "In the hillside areas of Santa Barbara, yes — those neighborhoods sit in higher wildfire-risk zones, which can affect defensible-space and clearance rules near gates and fencing that we factor into installation work." },
      { q: "What gate and garage door brands do you repair in Santa Barbara?", a: "We repair and service all major brands for Santa Barbara customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "ventura",
    nearby: ["oxnard", "camarillo", "santa-barbara", "thousand-oaks", "ventura-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Ventura",
    metaTitle: "Gate & Garage Door Repair Ventura CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Ventura, CA. Same-day service, all brands, insured technicians. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Ventura CA", "garage door repair Ventura", "automatic gate Ventura County", "electric gate repair Ventura", "driveway gate repair Ventura", "garage door spring repair Ventura", "gate opener repair Ventura"],
...
We cover all of Ventura including the Midtown corridor, downtown, the east end near Oxnard, and the hillside communities above the city. Same-day service is available most days, with 24/7 emergency response always available.`,
    ...
    faq: [
      ...
      { q: "Do agricultural surroundings affect gate systems in Ventura?", a: "Yes. The agricultural land around Ventura generates more airborne dust and debris than urban neighborhoods, which regularly ends up in gate tracks and sensor housings." },
      { q: "Is hillside or wildfire-zone terrain a factor for gates in Ventura?", a: "Ventura's hillside terrain puts some neighborhoods in higher wildfire-risk zones, and that can affect clearance and material requirements for gates near vegetation — something we check on new installations." },
      { q: "Do you service commercial properties and businesses in Ventura?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Ventura businesses in addition to residential properties." },
    ],
  },
  {
    slug: "oxnard",
    nearby: ["ventura", "camarillo", "santa-barbara", "thousand-oaks", "ventura-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Oxnard",
    ...
    heroSubtitle: "Reliable gate and garage door repair in Oxnard — same-day service, honest pricing, fully insured.",
    extraKeywords: ["gate repair Oxnard CA", "garage door repair Oxnard", "electric gate Oxnard", "electric gate repair Oxnard", "driveway gate repair Oxnard", "garage door spring repair Oxnard", "gate opener repair Oxnard"],
...
Same-day service is available in Oxnard. For commercial clients with urgent needs, we prioritize fast response — a broken loading dock door means lost time.`,
    ...
    faq: [
      ...
      { q: "Do agricultural surroundings affect gate systems in Oxnard?", a: "Yes. Oxnard's surrounding farmland means more dust and plant debris than urban areas, and that debris is a common cause of fouled gate tracks and misaligned photocell sensors on our service calls here." },
      { q: "Is hillside or wildfire-zone terrain a factor for gates in Oxnard?", a: "In the hillside areas of Oxnard, yes — those neighborhoods sit in higher wildfire-risk zones, which can affect defensible-space and clearance rules near gates and fencing that we factor into installation work." },
      { q: "How much notice do you need for a same-day appointment in Oxnard?", a: "Most Oxnard customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  {
    slug: "camarillo",
    nearby: ["oxnard", "thousand-oaks", "ventura", "simi-valley", "ventura-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Camarillo",
    metaTitle: "Gate & Garage Door Repair Camarillo CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Camarillo, CA. Same-day service, all brands, bonded & insured. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Camarillo CA", "garage door repair Camarillo", "automatic gate Camarillo", "electric gate repair Camarillo", "driveway gate repair Camarillo", "garage door spring repair Camarillo", "gate opener repair Camarillo"],
...
Same-day service is available in Camarillo. Most standard repair calls are completed in a single visit.`,
    ...
    faq: [
      ...
      { q: "Do agricultural surroundings affect gate systems in Camarillo?", a: "Yes. Camarillo's farmland-adjacent location means gate tracks and photocell sensors collect debris faster than they would in a purely residential area, so we recommend more frequent cleaning." },
      { q: "Is hillside or wildfire-zone terrain a factor for gates in Camarillo?", a: "Some Camarillo properties sit in wildfire-risk hillside zones, which can bring additional defensible-space rules into play for gate and fence placement near brush." },
      { q: "Do you offer emergency weekend or after-hours service in Camarillo?", a: "Yes. Our emergency line is answered 24/7 for Camarillo customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "palmdale",
    nearby: ["lancaster", "santa-clarita"],
    arrivalTime: "Arrival within 1 hour",
    name: "Palmdale",
    ...
    heroSubtitle: "Trusted gate and garage door specialists serving Palmdale — same-day service, all brands, fully insured.",
    extraKeywords: ["gate repair Palmdale CA", "garage door repair Palmdale", "garage door spring repair Palmdale", "Antelope Valley gate repair", "electric gate repair Palmdale", "driveway gate repair Palmdale", "gate opener repair Palmdale"],
...
We serve all of Palmdale including Quartz Hill, the neighborhoods near the Palmdale Regional Airport, the communities along the 14 freeway, and the residential areas throughout the city. Same-day service available. Emergency service 24/7.`,
    ...
    faq: [
      ...
      { q: "How does the high-desert climate in Palmdale affect gate systems?", a: "The temperature swings in Palmdale — well over 100°F in summer, near freezing on winter nights — put more thermal stress on gate operator components than milder coastal climates, and blowing sand accelerates track wear." },
      { q: "Are gate systems in Palmdale typically newer than in older LA neighborhoods?", a: "Yes, for the most part. Palmdale's housing stock skews newer than much of Los Angeles, so service calls here tend to involve more recent gate operators rather than older legacy units." },
      { q: "How much notice do you need for a same-day appointment in Palmdale?", a: "Most Palmdale customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  {
    slug: "fresno",
    ...
    metaDescription: "Gate and garage door repair in Fresno, CA. Same-day service, all brands, insured technicians. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Fresno CA", "garage door repair Fresno", "automatic gate Fresno", "electric gate Fresno CA", "electric gate repair Fresno", "driveway gate repair Fresno", "garage door spring repair Fresno", "gate opener repair Fresno"],
...
We cover all of Fresno including the Tower District, Clovis adjacent neighborhoods, the communities near Fresno State, and the newer developments north of the city. Same-day service is available for most calls.`,
    ...
    faq: [
      ...
      { q: "How does the Central Valley climate affect gate systems in Fresno?", a: "Fresno sits in California's Central Valley agricultural belt, where summer highs regularly top 100°F and seasonal dust is heavy — that combination is hard on gate motor components and a common cause of sensor fouling." },
      { q: "Are properties in Fresno typically larger than in coastal LA neighborhoods?", a: "Often, yes. Fresno has more rural and ranch-style properties than coastal Los Angeles, with driveway gates that span greater distances — which affects the operator size and drive system we recommend." },
      { q: "Do you service gated communities and HOA properties in Fresno?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Fresno gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "santa-clarita",
    nearby: ["palmdale", "lancaster", "chatsworth", "northridge", "burbank"],
    arrivalTime: "Arrival within 1 hour",
    name: "Santa Clarita",
    ...
    extraKeywords: ["gate repair Santa Clarita CA", "garage door repair Valencia CA", "gate repair Newhall", "garage door repair Santa Clarita", "electric gate repair Santa Clarita", "driveway gate repair Santa Clarita", "garage door spring repair Santa Clarita", "gate opener repair Santa Clarita"],
...
We cover all of Santa Clarita including Valencia, Saugus, Newhall, Stevenson Ranch, Canyon Country, and all surrounding communities. Same-day service available seven days a week.`,
    ...
    faq: [
      ...
      { q: "How does the high-desert climate in Santa Clarita affect gate systems?", a: "Santa Clarita's high-desert climate brings 100°F+ summer highs, near-freezing winter nights, and frequent wind-blown sand and dust — that dust abrades gate tracks and clogs photocell sensors faster than in coastal or valley areas." },
      { q: "Are gate systems in Santa Clarita typically newer than in older LA neighborhoods?", a: "Generally, yes. Santa Clarita is largely built out with newer, post-1990s master-planned developments, so we see more warranty-era hardware and fewer of the decades-old legacy systems common in older LA neighborhoods." },
      { q: "Do you offer emergency weekend or after-hours service in Santa Clarita?", a: "Yes. Our emergency line is answered 24/7 for Santa Clarita customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "long-beach",
    nearby: ["torrance", "redondo-beach", "huntington-beach", "anaheim", "orange-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Long Beach",
    ...
    extraKeywords: ["gate repair Long Beach CA", "garage door repair Long Beach", "electric gate Long Beach", "commercial gate repair Long Beach", "electric gate repair Long Beach", "driveway gate repair Long Beach", "garage door spring repair Long Beach", "gate opener repair Long Beach"],
...
Same-day service is available throughout Long Beach. For commercial clients, we understand downtime costs and prioritize fast response.`,
    ...
    faq: [
      ...
      { q: "How does the coastal climate in Long Beach affect gate hardware?", a: "The salt air along the Long Beach coastline accelerates corrosion on exposed gate hinges, hardware, and tracks compared to inland areas, so we recommend corrosion-resistant materials for anything installed near the water." },
      { q: "Do I need HOA or architectural review approval for gate repairs in Long Beach?", a: "Often, yes. Many Long Beach neighborhoods have HOA or architectural review board rules governing visible exterior hardware, and we're used to working within those requirements and coordinating with property managers directly." },
      { q: "Do you offer emergency weekend or after-hours service in Long Beach?", a: "Yes. Our emergency line is answered 24/7 for Long Beach customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "orange",
    nearby: ["anaheim", "irvine", "fullerton", "newport-beach", "orange-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Orange",
    metaTitle: "Gate & Garage Door Repair Orange CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Orange, CA. Same-day service, all brands, bonded & insured. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Orange CA", "garage door repair Orange County", "automatic gate Orange CA", "electric gate repair Orange", "driveway gate repair Orange", "garage door spring repair Orange", "gate opener repair Orange"],
...
We cover all of Orange including the historic downtown area, the neighborhoods near Chapman University, and all residential streets throughout the city. Same-day service seven days a week.`,
    ...
    faq: [
      ...
      { q: "Do I need HOA approval for gate or garage door repairs in Orange?", a: "Many Orange neighborhoods are part of master-planned HOA communities with specific rules on approved gate styles and materials — we factor that into the estimate and can coordinate with your HOA directly." },
      { q: "Does the coastal climate affect gate hardware in Orange?", a: "Orange's proximity to the coast means salt air is a real factor in hardware wear, and we see faster corrosion on unprotected gate components here than further inland." },
      { q: "Do you service commercial properties and businesses in Orange?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Orange businesses in addition to residential properties." },
    ],
  },
  {
    slug: "fullerton",
    nearby: ["anaheim", "orange", "hacienda-heights", "long-beach", "orange-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Fullerton",
    metaTitle: "Gate & Garage Door Repair Fullerton CA | Real Gate & Garage Door",
    metaDescription: "Gate and garage door repair in Fullerton, CA. Same-day service, all brands, fully insured. Call (818) 915-5715.",
    ...
    extraKeywords: ["gate repair Fullerton CA", "garage door repair Fullerton", "electric gate Fullerton CA", "electric gate repair Fullerton", "driveway gate repair Fullerton", "garage door spring repair Fullerton", "gate opener repair Fullerton"],
...
We cover all of Fullerton including the neighborhoods near CSUF, downtown Fullerton, and the communities near the 57 and 91 freeway corridors. Available seven days a week.`,
    ...
    faq: [
      ...
      { q: "Do I need HOA approval for gate or garage door repairs in Fullerton?", a: "Fullerton's master-planned communities typically require HOA sign-off on visible gate or garage door changes, which is standard practice here and something we build into the timeline." },
      { q: "Does the coastal climate affect gate hardware in Fullerton?", a: "For Fullerton properties near the coast, salt air exposure is one of the bigger factors in how often gate hardware needs attention, more so than in inland Orange County." },
      { q: "Do you service gated communities and HOA properties in Fullerton?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Fullerton gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "anaheim",
    nearby: ["orange", "fullerton", "irvine", "huntington-beach", "orange-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Anaheim",
    ...
    extraKeywords: ["gate repair Anaheim CA", "garage door repair Anaheim", "commercial gate Anaheim", "electric gate Anaheim Hills", "electric gate repair Anaheim", "driveway gate repair Anaheim", "garage door spring repair Anaheim", "gate opener repair Anaheim"],
...
Same-day service is the standard for all Anaheim repair calls. Commercial emergency response is available 24/7.`,
    ...
    faq: [
      ...
      { q: "Do I need HOA approval for gate or garage door repairs in Anaheim?", a: "Often, yes. Much of Anaheim is governed by master-planned community HOAs with strict architectural guidelines controlling gate style, color, and material, so we always confirm HOA requirements before starting visible repair or replacement work." },
      { q: "Does the coastal climate affect gate hardware in Anaheim?", a: "In the coastal parts of Anaheim, yes — salt air accelerates corrosion on exposed hinges and steel hardware, so we typically recommend corrosion-resistant components for properties near the water." },
      { q: "How much notice do you need for a same-day appointment in Anaheim?", a: "Most Anaheim customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  {
    slug: "manhattan-beach",
    nearby: ["redondo-beach", "torrance", "culver-city", "santa-monica"],
    arrivalTime: "Arrival within 1 hour",
    ...
    extraKeywords: ["gate repair Manhattan Beach CA", "garage door repair Manhattan Beach", "automatic gate Manhattan Beach", "driveway gate Manhattan Beach", "electric gate repair Manhattan Beach", "driveway gate repair Manhattan Beach", "garage door spring repair Manhattan Beach", "gate opener repair Manhattan Beach"],
...
Same-day service is available in Manhattan Beach. We work with full professionalism and clean up after ourselves — this is your home and we treat it accordingly.`,
    ...
    faq: [
      ...
      { q: "How does the coastal climate in Manhattan Beach affect gate hardware?", a: "Manhattan Beach's beach-adjacent location means more salt exposure on metal gate components than you'd see a few miles inland, which is why hardware corrosion is one of the more common issues we find here." },
      { q: "Do I need HOA or architectural review approval for gate repairs in Manhattan Beach?", a: "Many Manhattan Beach properties fall under HOA or beach-city architectural review guidelines that regulate visible gate and garage door changes, and we can work directly with your HOA's approved-vendor process if needed." },
      { q: "Do you service gated communities and HOA properties in Manhattan Beach?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Manhattan Beach gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "redondo-beach",
    nearby: ["manhattan-beach", "torrance", "long-beach", "culver-city"],
    arrivalTime: "Arrival within 1 hour",
    name: "Redondo Beach",
    ...
    extraKeywords: ["gate repair Redondo Beach CA", "garage door repair Redondo Beach", "electric gate Redondo Beach", "electric gate repair Redondo Beach", "driveway gate repair Redondo Beach", "garage door spring repair Redondo Beach", "gate opener repair Redondo Beach"],
...
We cover all of Redondo Beach including North Redondo, the Riviera Village, the harbor area, and all residential streets. Same-day service seven days a week, emergency service 24/7.`,
    ...
    faq: [
      ...
      { q: "How does the coastal climate in Redondo Beach affect gate hardware?", a: "Being this close to the coast, Redondo Beach properties see faster hardware corrosion on gates and garage doors than inland South Bay neighborhoods, especially on unprotected steel." },
      { q: "Do I need HOA or architectural review approval for gate repairs in Redondo Beach?", a: "It depends on your property, but a number of Redondo Beach communities have architectural review rules covering exterior hardware, so we always check before finalizing a repair or replacement plan." },
      { q: "What gate and garage door brands do you repair in Redondo Beach?", a: "We repair and service all major brands for Redondo Beach customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "torrance",
    nearby: ["redondo-beach", "manhattan-beach", "long-beach", "culver-city"],
    arrivalTime: "Arrival within 1 hour",
    name: "Torrance",
    ...
    extraKeywords: ["gate repair Torrance CA", "garage door repair Torrance", "commercial garage door Torrance", "electric gate Torrance", "electric gate repair Torrance", "driveway gate repair Torrance", "garage door spring repair Torrance", "gate opener repair Torrance"],
...
Same-day service is available throughout Torrance. Commercial emergency response is available 24/7.`,
    ...
    faq: [
      ...
      { q: "How does the coastal climate in Torrance affect gate hardware?", a: "The salt air along the Torrance coastline accelerates corrosion on exposed gate hinges, hardware, and tracks compared to inland areas, so we recommend corrosion-resistant materials for anything installed near the water." },
      { q: "Do I need HOA or architectural review approval for gate repairs in Torrance?", a: "Often, yes. Many Torrance neighborhoods have HOA or architectural review board rules governing visible exterior hardware, and we're used to working within those requirements and coordinating with property managers directly." },
      { q: "Do you service commercial properties and businesses in Torrance?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Torrance businesses in addition to residential properties." },
    ],
  },
  {
    slug: "irvine",
    nearby: ["newport-beach", "orange", "anaheim", "huntington-beach", "orange-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Irvine",
    ...
    extraKeywords: ["gate repair Irvine CA", "garage door repair Irvine", "gated community gate repair Irvine", "HOA gate repair Irvine", "electric gate repair Irvine", "driveway gate repair Irvine", "garage door spring repair Irvine", "gate opener repair Irvine"],
...
We cover all of Irvine including all village communities, the Great Park neighborhoods, UC Irvine area, and the corporate campus district. Same-day service available seven days a week.`,
    ...
    faq: [
      ...
      { q: "Do I need HOA approval for gate or garage door repairs in Irvine?", a: "Often, yes. Much of Irvine is governed by master-planned community HOAs with strict architectural guidelines controlling gate style, color, and material, so we always confirm HOA requirements before starting visible repair or replacement work." },
      { q: "Does the coastal climate affect gate hardware in Irvine?", a: "In the coastal parts of Irvine, yes — salt air accelerates corrosion on exposed hinges and steel hardware, so we typically recommend corrosion-resistant components for properties near the water." },
      { q: "What gate and garage door brands do you repair in Irvine?", a: "We repair and service all major brands for Irvine customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "huntington-beach",
    nearby: ["newport-beach", "long-beach", "anaheim", "irvine", "orange-county"],
    arrivalTime: "Arrival within 1 hour",
    ...
    extraKeywords: ["gate repair Huntington Beach CA", "garage door repair Huntington Beach", "coastal gate repair HB", "Surf City garage door repair", "electric gate repair Huntington Beach", "driveway gate repair Huntington Beach", "garage door spring repair Huntington Beach", "gate opener repair Huntington Beach"],
...
We cover all of Huntington Beach including the downtown strand area, Huntington Harbour, Bolsa Chica, and all residential communities. Same-day and emergency service always available.`,
    ...
    faq: [
      ...
      { q: "Do I need HOA approval for gate or garage door repairs in Huntington Beach?", a: "Huntington Beach's master-planned communities typically require HOA sign-off on visible gate or garage door changes, which is standard practice here and something we build into the timeline." },
      { q: "Does the coastal climate affect gate hardware in Huntington Beach?", a: "For Huntington Beach properties near the coast, salt air exposure is one of the bigger factors in how often gate hardware needs attention, more so than in inland Orange County." },
      { q: "How much notice do you need for a same-day appointment in Huntington Beach?", a: "Most Huntington Beach customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
  {
    slug: "newport-beach",
    nearby: ["huntington-beach", "irvine", "orange", "orange-county"],
    arrivalTime: "Arrival within 1 hour",
    name: "Newport Beach",
    ...
    extraKeywords: ["gate repair Newport Beach CA", "automatic gate Newport Beach", "estate gate Newport Beach", "garage door repair Newport Beach CA", "electric gate repair Newport Beach", "driveway gate repair Newport Beach", "garage door spring repair Newport Beach", "gate opener repair Newport Beach"],
...
The coastal environment in Newport Beach is demanding on gate hardware, particularly near the harbor and bay. We bring the right materials and expertise for salt-air environments and recommend appropriate maintenance intervals to keep your gate system working reliably for years.`,
    ...
    faq: [
      ...
      { q: "Do I need HOA approval for gate or garage door repairs in Newport Beach?", a: "Many Newport Beach neighborhoods are part of master-planned HOA communities with specific rules on approved gate styles and materials — we factor that into the estimate and can coordinate with your HOA directly." },
      { q: "Does the coastal climate affect gate hardware in Newport Beach?", a: "Newport Beach's proximity to the coast means salt air is a real factor in hardware wear, and we see faster corrosion on unprotected gate components here than further inland." },
      { q: "Do you offer emergency weekend or after-hours service in Newport Beach?", a: "Yes. Our emergency line is answered 24/7 for Newport Beach customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "lancaster",
    nearby: ["palmdale", "santa-clarita"],
    arrivalTime: "Arrival within 1 hour",
    name: "Lancaster",
    ...
    extraKeywords: ["gate repair Lancaster CA", "garage door repair Lancaster", "Antelope Valley gate repair", "garage door spring repair Lancaster CA", "electric gate repair Lancaster", "driveway gate repair Lancaster", "garage door spring repair Lancaster", "gate opener repair Lancaster"],
...
We cover all of Lancaster including Quartz Hill, the communities near the Air Force Plant 42, the established neighborhoods near Lancaster Boulevard, and the newer residential developments throughout the city. Same-day service available seven days a week.`,
    ...
    faq: [
      ...
      { q: "How does the high-desert climate in Lancaster affect gate systems?", a: "Lancaster sees real high-desert extremes, from triple-digit summer heat to cold winter nights, and the wind-driven dust common here is one of the fastest ways to foul a gate's sensors and tracks." },
      { q: "Are gate systems in Lancaster typically newer than in older LA neighborhoods?", a: "Largely, yes — Lancaster's newer developments mean the gate hardware we service is often more recent than what we find in older, established LA neighborhoods." },
      { q: "Do you service commercial properties and businesses in Lancaster?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Lancaster businesses in addition to residential properties." },
    ],
  },
  {
    slug: "glendora",
    nearby: ["pasadena", "hacienda-heights", "alhambra", "fullerton"],
    arrivalTime: "Arrival within 1 hour",
    name: "Glendora",
    metaTitle: "Gate & Garage Door Repair Glendora CA | Real Gate & Garage Door",
    metaDescription: "Expert gate and garage door repair in Glendora, CA. Same-day service, all brands, bonded & insured. Call (818) 915-5715.",
...
Real Gate & Garage Door serves all of Glendora, from the historic Village downtown to the newer neighborhoods on the east side. Same-day service is available for most calls, and our technicians carry parts for all major gate and garage door brands.`,
    ...
    faq: [
      ...
      { q: "Does Santa Ana wind exposure affect service calls in Glendora?", a: "Yes. Glendora's San Gabriel Valley location sees more wind-driven debris during Santa Ana events, which is a frequent cause of the sensor and obstruction issues we get called out for." },
      { q: "Are hillside driveways common in Glendora?", a: "Some Glendora properties sit on foothill lots with inclined driveways, and that incline is a real factor in how hard the gate operator has to work on every open-close cycle." },
      { q: "Do you offer emergency weekend or after-hours service in Glendora?", a: "Yes. Our emergency line is answered 24/7 for Glendora customers, including for a gate stuck open or an inoperable garage door outside normal business hours." },
    ],
  },
  {
    slug: "bakersfield",
...
We cover Bakersfield's residential neighborhoods and growing suburban developments alike, from simple garage door tune-ups to full automatic gate installations. Same-day service is available for most calls, with upfront pricing before any work begins.`,
    ...
    faq: [
      ...
      { q: "How does the Central Valley climate affect gate systems in Bakersfield?", a: "Summers in Bakersfield routinely exceed 100°F with significant agricultural dust in the air, both of which accelerate wear on gate operator motors and photocell sensors compared to coastal climates." },
      { q: "Are properties in Bakersfield typically larger than in coastal LA neighborhoods?", a: "Many Bakersfield properties are larger, rural, or ranch-style, which means longer driveway gate spans than typical suburban LA lots and often calls for heavier-duty operators." },
      { q: "What gate and garage door brands do you repair in Bakersfield?", a: "We repair and service all major brands for Bakersfield customers, including LiftMaster, Chamberlain, Genie, DoorKing, Viking, and All-O-Matic, along with older or discontinued models many other companies won't touch." },
    ],
  },
  {
    slug: "orange-county",
    nearby: ["anaheim", "orange", "irvine", "huntington-beach", "newport-beach", "fullerton"],
    arrivalTime: "Arrival within 1 hour",
    name: "Orange County",
...
We work with the gated-community access systems common in OC's planned developments as well as standalone residential gates and garage doors, carrying parts for all major brands so most repairs are completed in a single visit.`,
    ...
    faq: [
      ...
      { q: "Do I need HOA approval for gate or garage door repairs in Orange County?", a: "Often, yes. Much of Orange County is governed by master-planned community HOAs with strict architectural guidelines controlling gate style, color, and material, so we always confirm HOA requirements before starting visible repair or replacement work." },
      { q: "Does the coastal climate affect gate hardware in Orange County?", a: "In the coastal parts of Orange County, yes — salt air accelerates corrosion on exposed hinges and steel hardware, so we typically recommend corrosion-resistant components for properties near the water." },
      { q: "Do you service commercial properties and businesses in Orange County?", a: "Yes. We service commercial gates, security gates, and commercial garage doors for Orange County businesses in addition to residential properties." },
    ],
  },
  {
    slug: "ventura-county",
    nearby: ["oxnard", "ventura", "camarillo", "thousand-oaks", "simi-valley", "santa-barbara"],
    arrivalTime: "Arrival within 1 hour",
    name: "Ventura County",
...
We handle everything from automatic driveway gates on Camarillo and Thousand Oaks estates to everyday garage door repair in Oxnard and Ventura neighborhoods, with same-day service and parts stocked for all major brands.`,
    ...
    faq: [
      ...
      { q: "Do agricultural surroundings affect gate systems in Ventura County?", a: "Yes. Ventura County's farmland-adjacent location means gate tracks and photocell sensors collect debris faster than they would in a purely residential area, so we recommend more frequent cleaning." },
      { q: "Is hillside or wildfire-zone terrain a factor for gates in Ventura County?", a: "Some Ventura County properties sit in wildfire-risk hillside zones, which can bring additional defensible-space rules into play for gate and fence placement near brush." },
      { q: "Do you service gated communities and HOA properties in Ventura County?", a: "Yes. We regularly work with HOAs, property managers, and gate committees on Ventura County gated communities, and can coordinate directly with your HOA's approved-vendor process when one is required." },
    ],
  },
  {
    slug: "hacienda-heights",
    nearby: ["glendora", "fullerton", "alhambra", "anaheim", "pasadena"],
    arrivalTime: "Arrival within 1 hour",
    name: "Hacienda Heights",
    metaTitle: "Gate & Garage Door Repair Hacienda Heights CA | Real Gate & Garage Door",
    metaDescription: "Expert gate and garage door repair in Hacienda Heights, CA. Same-day service, all brands, bonded & insured. Call (818) 915-5715.",
...
Our technicians carry parts for all major brands and are familiar with the hillside driveway conditions common in the area, from steep approach gates to multi-car garage setups.`,
    ...
    faq: [
      ...
      { q: "Does Santa Ana wind exposure affect service calls in Hacienda Heights?", a: "Yes. Hacienda Heights's inland San Gabriel Valley location means more Santa Ana wind exposure in fall than coastal LA, and wind-driven debris is one of the most common causes of gate sensor misalignment we diagnose here." },
      { q: "Are hillside driveways common in Hacienda Heights?", a: "In the foothill areas of Hacienda Heights, yes — sloped driveways are common, and the added grade puts more continuous load on gate operators than flat-lot properties see." },
      { q: "How much notice do you need for a same-day appointment in Hacienda Heights?", a: "Most Hacienda Heights customers who call before early afternoon get a same-day appointment; calls later in the day are typically scheduled for the next morning instead." },
    ],
  },
];
